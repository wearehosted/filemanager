...
return [
    ...
    'welcome' => 'Chào mừng vào FileManager, %s!',
    ...
    'donate_text' => 'Nếu bạn thích FileManager, xin hãy quyên góp để hỗ trợ việc phát triển phần mềm cho người dùng!',
    ...
    'default_lang_behavior' => 'FileManager sẽ khớp ngôn ngữ bạn đang sử dụng mặc định trên trình duyệt (trường hợp ngôn ngữ bạn dùng chưa hỗ trợ, ngôn ngữ dự phòng là tiếng Anh).',
    'donation' => 'Quyên góp',

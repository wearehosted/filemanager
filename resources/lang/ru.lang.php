...
return [
    ...
    'lang_name' => 'язык',
    'default_lang_behavior' => 'FileManager попробует выбрать язык вашего браузера по умолчанию, иначе будет выбран Английский.',
    ...
    'donate_text' => 'Если вам нравится FileManager, вы можете пожертвовать деньги для поддержки разработки!',

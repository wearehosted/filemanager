...
return [
    ...
    'default_lang_behavior' => 'FileManager ще се опита да съвпадне с езика на браузъра по подразбиране (резервният вариант е английски).',
    'donation' => 'Дарение',
    'donate_text' => 'Ако харесвате FileManager, помислете за дарение в подкрепа на развитието!',
